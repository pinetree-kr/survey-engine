...
const questionTypes = [
  { type: 'short-text' as QuestionType, icon: Type, label: '단답형', description: '한 줄 텍스트' },
  { type: 'long-text' as QuestionType, icon: AlignLeft, label: '장문형', description: '여러 줄 텍스트' },
  { type: 'single-choice' as QuestionType, icon: CheckSquare, label: '단일 선택', description: '라디오 버튼' },
  { type: 'multiple-choice' as QuestionType, icon: ListChecks, label: '다중 선택', description: '체크박스' },
